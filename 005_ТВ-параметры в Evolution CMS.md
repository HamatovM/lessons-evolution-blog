...
| Имя             | Заголовок            |               Описание | Категория | Тип Ввода |
| --------------- | -------------------- | ---------------------: | --------- | --------- |
| metatitle       | Meta title           |   Содежимое тега title | SEO       | Text      |
| metadescription | Meta description     | Содержимое description | SEO       | Text      |
| post_photo      | Главное фото к посту |           Главное фото | Контент   | Image     |
| post_tags       | Теги поста           |                   Теги | Контент   | selector  |
